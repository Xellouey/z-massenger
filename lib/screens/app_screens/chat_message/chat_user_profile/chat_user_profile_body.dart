          ...
          child:
            ...
            Container(
                ...
                child: Column(children: [
                  ...
                  const VSpace(Sizes.s10),
                  Text(
                      chatCtrl.pData != null && chatCtrl.pData["status"] != null
                          ? (chatCtrl.pData["status"] == "Offline"
                              ? DateFormat('HH:mm').format(
                                  DateTime.fromMillisecondsSinceEpoch(
                                      int.parse(chatCtrl.pData['lastSeen'])))
                              : chatCtrl.pData["status"])
                          : "",
            ...
            Text(
              chatCtrl.pData != null && chatCtrl.pData["statusDesc"] != null
                  ? chatCtrl.pData["statusDesc"]
                  : "",
              textAlign: TextAlign.center,
              style:
